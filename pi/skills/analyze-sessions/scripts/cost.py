...
Examples:
  uv run --no-project cost.py                                # last 7d, by day
  uv run --no-project cost.py --since 30d --by project
  uv run --no-project cost.py --since 30d --by model
  uv run --no-project cost.py --cwd /Volumes/T7/code/blanc   # one project, all time
  uv run --no-project cost.py --since 30d --by session --limit 10 --show-subagents
"""
