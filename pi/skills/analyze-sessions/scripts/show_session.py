...
Examples:
  ...
  uv run --no-project show_session.py --cwd /Volumes/T7/code/blanc --latest
  uv run --no-project show_session.py --session 019e475b --max-tool-output 4000
  uv run --no-project show_session.py --latest --include-subagents-content
"""
